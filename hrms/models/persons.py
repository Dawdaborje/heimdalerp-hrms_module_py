...
GENRE_TYPE_MALE = "M"
GENRE_TYPE_FEMALE = "F"
GENRE_TYPES = ((GENRE_TYPE_MALE, _("Male")), (GENRE_TYPE_FEMALE, _("Female")))
...
class PhysicalAddress(models.Model):
    ...
    street_address = models.CharField(
        _("street address"), max_length=150, default="", blank=True
    )
    floor_number = models.CharField(
        _("floor number"), max_length=4, default="", blank=True
    )
    apartment_number = models.CharField(
        _("apartment number"), max_length=6, default="", blank=True
    )
    ...
    postal_code = models.CharField(
        _("postal code"), max_length=20, default="", blank=True
    )
...
class Company(models.Model):
    ...
    slogan = models.CharField(_("slogan"), max_length=200, default="", blank=True)
...
class PersonProfile(models.Model):
    ...
    birth_date = models.DateField(
        _("birth date"), blank=True, null=True, validators=[date_is_past]
    )
    ...
    phone_numbers = models.CharField(
        _("phone numbers"), max_length=300, default="", blank=True
    )
