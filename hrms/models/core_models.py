...
from .persons import GENRE_TYPES, Company, PersonProfile
...
class Ethnicity(models.Model):
    ...
    points = models.DecimalField(
        _("points"), max_digits=5, decimal_places=2, default=0.00
    )
...
class Aptitude(models.Model):
    ...
    description = models.CharField(_("description"), max_length=150, default="")
    points = models.DecimalField(
        _("points"), max_digits=5, decimal_places=2, default=0.00
    )
...
class Sanction(models.Model):
    ...
    points = models.DecimalField(
        ...
        default=0.00,
        help_text=_(
            "Enter points greater than zero here, but they'll be "
...
class EmployeeSpeaksLanguage(models.Model):
    ...
    level = models.CharField(
        _("level"), max_length=1, choices=LANGUAGE_SPOKEN_LEVELS, default=""
    )
    points = models.DecimalField(
        _("points"),
        max_digits=5,
    ...
    def __str__(self):
        r = _noop("%(employee)s speaks %(language)s") % {
    ...
    class Meta:
        ...
        default_permissions = ("view", "add", "change", "delete")
        db_table = "tblEmployeeSpeaksLanguage"
...
class EmployeeHasSanction(models.Model):
    ...
    what_happened = models.TextField(_("what happened"), default="")
    ...
    def __str__(self):
        r = _noop("%(degree)s at %(academia)s") % {
    ...
    class Meta:
        ...
        default_permissions = ("view", "add", "change", "delete")
        db_table = "tblEmployeeHasSanction"
...
class AcademicInstitution(models.Model):
    ...
    class Meta:
        ...
        default_permissions = ("view", "add", "change", "delete")
        db_table = "tblAcademicInstitution"
...
class EmployeeHasDegree(models.Model):
    ...
    ingress_year = models.PositiveSmallIntegerField(
        _("ingress year"), blank=True, null=True
    )
    egress_year = models.PositiveSmallIntegerField(
        _("egress year"), blank=True, null=True
    )
...
class AreaHasEmployee(models.Model):
    ...
    date_since = models.DateField(
        _("date since"), blank=True, null=True, validators=[date_is_present_or_past]
    )
